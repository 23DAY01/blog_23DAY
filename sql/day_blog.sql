...
CREATE TABLE `day_article`  (
  ...
  `article_cover` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '文章缩略图',
  ...
  `deleted` tinyint(1) NULL DEFAULT 0 COMMENT '逻辑删除 0否 NULL是',
...
CREATE TABLE `day_comment`  (
  ...
  `top_id` int NULL DEFAULT NULL COMMENT '顶级评论id，默认为自身id',
...
CREATE TABLE `day_website_config`  (
  ...
  `about` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '关于我',
