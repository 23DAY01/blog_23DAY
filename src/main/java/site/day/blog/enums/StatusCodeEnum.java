...
public enum StatusCodeEnum {
    ...
    UNKNOWN_RUNTIME_ERROR(4009901, StatusMsgConst.UNKNOWN_RUNTIME_ERROR),
    UNKNOWN_SYSTEM_ERROR(4009902, StatusMsgConst.UNKNOWN_SYSTEM_ERROR),
    ...
    AUTH_FAIL(4000306, StatusMsgConst.AUTH_FAIL),
    ...
    AUTH_USER_ACCOUNT_LOCKED(4000311, StatusMsgConst.AUTH_USER_ACCOUNT_LOCKED),
    AUTH_SESSION_CONCURRENCE_MAX(4000312, StatusMsgConst.AUTH_SESSION_CONCURRENCE_MAX),
    AUTH_USER_ACCOUNT_DISABLED(4000314, StatusMsgConst.AUTH_USER_ACCOUNT_DISABLED),
    AUTH_USER_ACCOUNT_EXPIRED(4000315, StatusMsgConst.AUTH_USER_ACCOUNT_EXPIRED),
    AUTH_USER_CREDENTIALS_EXPIRED(4000316, StatusMsgConst.AUTH_USER_CREDENTIALS_EXPIRED),
    AUTH_USER_BAD_CREDENTIAL(4000317, StatusMsgConst.AUTH_BAD_CREDENTIAL),
