...
public enum StatusCodeEnum {
    ...
    AUTH_PASSWORD_ERROR(4000317,StatusMsgConst.AUTH_PASSWORD_ERROR),
    AUTH_QQ_ERROR(4000318,StatusMsgConst.AUTH_QQ_ERROR),
    ...
    CATEGORY_ARTICLE_RELATION(4001203,StatusMsgConst.CATEGORY_ARTICLE_RELATION),
    //业务错误-tag
    TAG_NAME_REPEAT(4001301, StatusMsgConst.TAG_NAME_REPEAT),
    TAG_MISSING(4001302, StatusMsgConst.TAG_MISSING),
    TAG_ARTICLE_RELATION(4001303,StatusMsgConst.TAG_ARTICLE_RELATION),
    //业务错误-菜单
    MENU_ROLE_RELATION(4001401,StatusMsgConst.MENU_ROLE_RELATION),
    //业务错误-资源
    RESOURCE_ROLE_RELATION(4001501,StatusMsgConst.RESOURCE_ROLE_RELATION),
